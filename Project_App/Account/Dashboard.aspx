...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container align-items-start" style="padding: 5px 0px 5px 0px">
        <asp:Panel ID="Panel1" runat="server">
            ...
            <div class="row my-1" style="width: 50%">
    ...
    <div class="flex align-items-start gap-5">
        <div class="row mx-1 " style="width: 50%">
            <asp:TextBox ID="Search_TxtBox" runat="server" CssClass="col" placeholder="Enter Name to Search" OnTextChanged="Search_TxtBox_TextChanged" AutoPostBack="true" ></asp:TextBox>
            <asp:Button ID="Button3" runat="server" Text="Clear" CssClass="col" OnClick="Button3_Click" CausesValidation="false"/>
        </div>
        <br />
